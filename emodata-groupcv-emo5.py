"""
emodata：3 维情感（Valence / Arousal / Boredom）+ AOIGazeProportion + OffScreenGazeProportion（共 5 维），
按 ParticipantNum 分组的嵌套交叉验证。Pipeline：Imputer → StandardScaler → SVC(RBF)。
"""
import warnings
...
def main():
    ...
    print(
        f"特征: 3 情感 + AOI 比例 + OffScreen 比例（5 维）| "
    ...
    print("\n===============================================")
    print(f"{OUTER_SPLITS}-Fold GroupCV Summary (emodata, 3 emo + 2 gaze ratio + SVM)")
